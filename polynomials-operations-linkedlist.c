...
void main()
{
    ...
    traverse(start_r);
    poly_subtract(&start_p, &start_q, &start_r);
    printf("Substraction of two polynomials:\n");
    traverse(start_r);
    start_r = NULL;
...
void poly_subtract(struct node **start_p, struct node **start_q, struct node **start_r)
{
    int c, e;
    struct node *pptr, *qptr;
    *start_r = NULL;
